...
import { Loader2, PlugZap, BarChart3, Database } from 'lucide-react';
    ...
    <>
      {isRunning && (
        <div className="running-banner">
          <span className="pulse"><Loader2 size={16} className="animate-spin" /></span>
      ...
      <main className="main-area" style={isRunning ? { paddingTop: 48 } : undefined}>
        ...
        <div className="content">
          ...
          {activeNav === 'scenarios' && selectedScenario === 1 ? (
            ...
            <div className="loading-overlay">
              <div className="spinner"><Loader2 size={32} className="animate-spin" /></div>
        ...
        <footer className="page-footer">
          <div style={{ display: 'flex', alignItems: 'center', gap: 6 }}>
            <Database size={14} /> Powered by <strong>Smart Meeting Efficiency Analyzer v5</strong> · n8n + GPT-4.1 + Fathom AI
          </div>
