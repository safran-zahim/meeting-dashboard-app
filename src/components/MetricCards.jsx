import { Shuffle, CheckCircle, Mic } from 'lucide-react';

export default function MetricCards({ summary }) {
  const metrics = [
    {
      icon: <Shuffle size={20} />, bg: 'var(--orange-pale)', color: 'var(--orange)',
      value: `${summary.avgDecisionRatio}%`, label: 'Decision Ratio',
    },
    {
      icon: <CheckCircle size={20} />, bg: 'var(--green-bg)', color: 'var(--green)',
      value: `${summary.avgNecessity}/100`, label: 'Necessity Score',
    },
    {
      icon: <Mic size={20} />, bg: 'var(--blue-bg)', color: 'var(--blue)',
