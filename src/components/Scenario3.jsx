      ...
      <header className="scenario3-header">
        <div className="scenario3-header-left">
          ...
          <div className="scenario3-header-logo">
            <div className="scenario3-header-logo-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Network size={24} /></div>
            <div>
              <h1 className="scenario3-header-title">Meeting Intelligence</h1>
              <p className="scenario3-header-sub">CPO Command Center · Powered by Fathom AI</p>
            </div>
          </div>
        </div>
                    ...
                    <div className="card scenario3-panel scenario3-coaching-panel">
                      ...
                      {!aiInsight && !loadingInsight && (
                        <div className="scenario3-coaching-cta">
                          <div className="scenario3-coaching-cta-icon" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}><Sparkles size={24} color="var(--purple)" /></div>
